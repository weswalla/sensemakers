...
export class DBInstance {
  ...
  public collections: {
    ...
    notifications: FirebaseFirestore.CollectionReference<FirebaseFirestore.DocumentData>;
  };
  ...
  constructor() {
    ...
    this.collections = {
      ...
      notifications: this.firestore.collection(CollectionNames.Notifications),
    };
  }
